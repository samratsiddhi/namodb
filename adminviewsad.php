                ...
                <div class="container-fluid">
                    ...
                    ?>
                                    <tr>
                                        ...
                                        <td>
                                        <figure>    
                                                <image src="<?php echo $basefilepath.$value['photo2'];?>" height="100" width="100"><br>
                                        </figure>
                                        </td>   
                                        <td>
                                        <figure>    
                                                <image src="<?php echo $basefilepath.$value['photo3'];?>" height="100" width="100"><br>
                                        </figure>
                                        </td>   
                                        <td>
                                        <figure>    
                                                <image src="<?php echo $basefilepath.$value['photo4'];?>" height="100" width="100"><br>
                                        </figure>
                                        </td>   
                                        <td>
                                             <a href="admindeletead.php?vehicleid=<?php echo $value['vehicleid']?>">Remove AD</a>
                                        </td>
                                    </tr> 
